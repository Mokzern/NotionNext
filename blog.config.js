...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mokzern', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个喜欢💻科技的🎻音乐人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://tac.tax', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客，音乐，日常', // 网站关键词 英文逗号隔开
